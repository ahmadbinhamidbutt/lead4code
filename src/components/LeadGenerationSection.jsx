      ...
      <div className="row">
        <div className="col-12 col-lg-6 px-3 px-md-5 mb-3 mb-md-0 position-relative">
          <img
            ...
            className="position-absolute vector-img-large"
            src={vectorImgLarge}
          />
          <img
            alt="vector-img-small"
            className="position-absolute vector-img-small"
            src={vectorImgSmall}
          />
          ...
          <div className="my-3 my-md-5 d-flex flex-column justify-content-center align-items-center">
            <LeadGenerationCard
